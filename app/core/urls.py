...
urlpatterns = [
    ...
    # Xero Data Import (Financial Reports)
    path('import/start/', xero_views.start_import, name='start_import'),
    path('import/<int:legal_entity_id>/<str:dataset_type_ids>/upload/', xero_views.import_upload_multiple, name='import_upload_multiple'),
