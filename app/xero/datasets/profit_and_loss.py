...
# # Wide format (default)
# df_wide = transform_profit_and_loss('files/management-report.xlsx', drop_profit_rows=False, melt_to_long=False)
# df_wide.to_excel("profit_and_loss_wide.xlsx", index=False)

# # Long format (database-friendly)
# df_long = transform_profit_and_loss('files/management-report.xlsx', drop_profit_rows=False, melt_to_long=True)
# df_long.to_excel("profit_and_loss_long.xlsx", index=False)
