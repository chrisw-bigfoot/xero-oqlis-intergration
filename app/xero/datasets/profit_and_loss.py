...
def transform_profit_loss(file_path: str, legal_entity: str = None, report_id: str = None, created_at: str = None, report_month: str = None, long_format: bool = False) -> pd.DataFrame:
    print(f"Transforming Profit and Loss from file: {file_path} ...")
    ...
    print(f"Finished transforming Profit and Loss. Resulting DataFrame has {len(df)} rows and {len(df.columns)} columns.")
    return df
