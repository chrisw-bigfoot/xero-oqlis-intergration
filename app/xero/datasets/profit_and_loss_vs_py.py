...
# # Wide format
# df_wide = transform_profit_and_loss_vs_py(file, drop_profit_rows=False, melt_to_long=False)
# df_wide.to_excel("profit_and_loss_vs_py_wide.xlsx", index=False)

# # Long format
# df_long = transform_profit_and_loss_vs_py(file, drop_profit_rows=False, melt_to_long=True)
# df_long.to_excel("profit_and_loss_vs_py_long.xlsx", index=False)